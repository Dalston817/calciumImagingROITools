...
%% the following calculates the area under the curve (AUC) between each stimulus onset to its offset
...
%%  This section finds each stimulus and calculates a new baseline for the response to that stimulus.  The new baseline is calculated as the mean of the 10 scans immediately preceding the stimulus
