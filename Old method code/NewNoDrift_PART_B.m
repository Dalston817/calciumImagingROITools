...
while k <= max_k
    ...
    sd_corrected=std(result(o,t0-10:t0)); %the variable "sd" is the stand dev of the 10 points preceding each stimulus 
    Y_corrected(o,StimulusArray(j,2):StimulusArray(j,3))=mean((result(o,t0-10:t0)))+m*sd_corrected;  %this command
    if MAXnodrift(o,j+1)<mean((result(o,t0-10:t0)))+m*sd_corrected   %this tests whether the signal ("result") is < [mean of 10 points before stim + "m" stand deviations]
